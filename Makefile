# Buscar archivos de fuente del kernel
x86_64_kernel_source_files := $(shell find src/impl/kernel -name *.c)
x86_64_kernel_object_files := $(patsubst src/impl/kernel/%.c, build/x86_64/%.o, $(x86_64_kernel_source_filesx86_64_c_source_files))


# Buscar archivos de fuente de C
...
x86_64_object_files := $(86_64_c_object_files) $(x86_64_asm_object_files)

$(kernel_object_files): build/kernel/%.o : src/impl/x86_64/%.c
	mkdir -p $(dir $@) && \
